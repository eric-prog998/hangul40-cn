...
完整音节与词句示范包含固定 AI 音频，未全部经母语教师逐条复核。口型和收音提示附有官方资料来源；听辨得分、跟读练习及复习自评均不代表发音准确度，本项目不提供自动发音评分。

## 许可与版权

Copyright © 2026 **Eric D**. All rights reserved.

项目当前版本采用 [Eric D Personal Use License](LICENSE)：允许下载、运行和为个人非商业用途进行本地修改；未经书面许可，不得重新发布、镜像、共享、分发修改版、改名/换品牌后出售或用于商业用途。源码公开不等于 OSI 开源。真人辅音起音仍按其原始 **CC0 1.0** 条款使用，其他第三方材料遵循各自许可证。历史版本曾采用 MIT License，旧版本已授予的权利不追溯撤销。
